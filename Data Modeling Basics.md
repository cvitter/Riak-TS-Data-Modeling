...
* [How tables are created in Riak TS](https://github.com/cvitter/Riak-TS-Data-Modeling/wiki/1.-Data-Modeling-Basics#creating-a-table)
...
* Use one of Riak TS's client libraries (Java, Python, Erlang, Node.js, .Net, Go, Ruby, PHP - see the following page for more information on Riak TS's client libraries: http://docs.basho.com/riak/ts/1.3.1/developing/) to execute the DDL;
* Or use the riak-admin command tool (see the following page for details on how to do this: http://docs.basho.com/riak/ts/1.3.1/using/creating-activating/#riak-admin).

For most of this documentation we will use riak-shell (http://docs.basho.com/riak/ts/1.3.1/using/riakshell/) to execute the example code. If you have already installed Riak TS let's go ahead and create the WeatherStationData table using riak-shell.
